 ...
 *                            According to the AoC website, all solutions *should* be completable in 15 seconds
 *                            regardless of hardware.
 *                            You may decrease this value for an increased challenge though do be aware of fluctuations
 *                            in execution time due to JVM warmup.
 ...
 *                            Useful when running the project with encrypted inputs (e.g. running a clone of someone
 *                            else's solution repo).
